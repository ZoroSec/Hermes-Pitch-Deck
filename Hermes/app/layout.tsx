...
export const metadata: Metadata = {
  title: "Heremes — Pitch decks investors actually read",
  description:
    "Heremes turns your startup story into a sharp, investor-ready pitch deck. Guided builder, proven slide structure, instant export.",
};
